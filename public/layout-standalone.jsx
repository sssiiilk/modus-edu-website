    ...
    <header style={headerStyles}>
      <Container>
        <div style={{
          ...
          >
            <img src={window.__resources.logo} alt="КАСТ" style={{ height: 44, width: 'auto' }} />
          </div>
      ...
      <Container>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <img src={window.__resources.logo} alt="КАСТ" style={{ height: 32, filter: 'brightness(0) invert(1)', opacity: 0.5 }} />
